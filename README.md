...
- **✍️ 손글씨 연습판**: 단어장 카드, 복습 카드, 헷갈리는 단어 카드에 있는 ✍️ 버튼을 누르면 화면 전체가
  반투명하게 바뀌면서 그 위에 손가락이나 애플펜슬로 직접 써볼 수 있습니다(마우스도 가능). Anki의 낙서장
  기능과 동일한 개념으로, **저장은 전혀 되지 않고** "지우기"로 언제든 다시 쓸 수 있으며 "닫기"를 누르면
  그냥 사라집니다.
